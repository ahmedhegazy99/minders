        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  ...
                  backgroundImage: NetworkImage(widget.posts.accountPic),
                ),
                title: Row(
                  children: [
                    //account name text
                    Text(
                      widget.posts.accountName,
                      style: TextStyle(
                ...
                subtitle: Text(widget.posts.accountUsername),
            ...
            Container(
              ...
              child: ((){
                if(widget.posts.postPic != null)
                  return Image.asset(widget.posts.postPic);
                else
                  return null;
              }()),
