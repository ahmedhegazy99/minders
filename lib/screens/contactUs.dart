            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  RoundedButton(
                    text: "  Whatsapp",
                    icon: Image.asset("assets/images/whatsapp.png", width: size.width * 0.5,),
                  ...
                  RoundedButton(
                    text: "  Messanger",
                    icon: Image.asset("assets/images/messenger.png", scale: 8,),
                  ...
                  Text(
                    "Want to make a Deal ?",
                    style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "englishTex", color: Colors.black, fontSize: 20),
                  ),
                  ...
                  RoundedButton(
                    ...
                    //color: Color(0xff25d366),
                    press: (){
                      launch("mailto:fundraisingminder@gmail.com?subject=We Have a Deal");
                    },
                  ),
